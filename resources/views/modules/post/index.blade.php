	...
	<div class="card">
		<div class="card-body">
			...
			<div class="d-flex align-middle justify-content-between">
				...
				<div class="">
					<a href="{{route('post.create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Post</a>
				</div>
			</div>
				...
				<tbody>
					@forelse ($posts as $post)
						<tr class="align-middle">
							...
							<td class="text-center"><a href="{{route('category.edit',$post->category?->id ?? 1) ?? null }}">{{$post->category?->name}}</a></td>
