    ...
    <div class="tt-media-item" data-active-file-id="{{ $mediaFile->id }}"
        ...
        <div class="tt-media-info-wrap p-2">
            ...
            <div class="tt-media-action-wrap d-flex align-items-center justify-content-center">
                <a class="tt-remove btn btn-sm px-2 m-2 btn-danger media-delete-btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Remove this file" data-href="{{ route('uppy.delete', $mediaFile->id) }}" onclick="confirmDelete(this)"><i
