...
<div class="tt-media-item" data-active-file-id="{{ $mediaFile->id }}"
    ...
    @php
         $data = getimagesize($mediaFile->media_file);
    @endphp
    ...
    <div class="tt-media-action-wrap d-flex align-items-center justify-content-center">
        <a class="tt-remove btn btn-sm px-2 m-2 btn-danger media-delete-btn" data-bs-toggle="tooltip"
...
@empty
<div class="text-center text-danger pt-5">{{ __('No data found') }}</div>
@endforelse
