    ...
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            <div class="text-center">
                <img class="jump mb-50" src="{{ staticAsset("frontend/assets/imgs/loading.svg") }}" alt="">
                <h6>Now Loading</h6>
                <div class="loader">
    ...
    <aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar position-right">
        ...
        <div class="sidebar-inner">
                    ...
                    <ul class="list-post">
                            ...
                            <div class="d-flex">
                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                    <a class="color-white" href="single.html">
                                        <img src="{{ staticAsset("frontend/assets/imgs/thumbnail-2.jpg") }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content media-body">
                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Vancouver woman
                                            finds pictures and videos of herself online</a></h6>
                        ...
                        <li class="mb-30 wow fadeIn animated">
                            <div class="d-flex">
                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                    <a class="color-white" href="single.html">
                                        <img src="{{ staticAsset("frontend/assets/imgs/thumbnail-3.jpg") }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content media-body">
                        ...
                        <li class="mb-30 wow fadeIn animated">
                            <div class="d-flex">
                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                    <a class="color-white" href="single.html">
                                        <img src="{{ staticAsset("frontend/assets/imgs/thumbnail-5.jpg") }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content media-body">
                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Reflections from
                                            a Token Black Friend</a></h6>
                                    <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                        ...
                        <li class="mb-30 wow fadeIn animated">
                            <div class="d-flex">
                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                    <a class="color-white" href="single.html">
                                        <img src="{{ staticAsset("frontend/assets/imgs/thumbnail-7.jpg") }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content media-body">
                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">How to Identify
                                            a Smart Person in 3 Minutes</a></h6>
                                    <div class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                        ...
                        <li class="wow fadeIn animated">
                            <div class="d-flex">
                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                    <a class="color-white" href="single.html">
                                        <img src="{{ staticAsset("frontend/assets/imgs/thumbnail-8.jpg") }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content media-body">
            ...
            <div class="sidebar-widget widget-ads mb-30">
                ...
                <a href="{{ staticAsset("frontend/assets/imgs/news-1.jpg") }}" class="play-video" data-animate="zoomIn"
                   data-duration="1.5s" data-delay="0.1s">
                    <img class="border-radius-10" src="{{ staticAsset("frontend/assets/imgs/ads-1.jpg") }}" alt="">
                </a>
            </div>
        </div>
    </aside>
                ...
                <div class="col-lg-10 col-md-9 order-1 order-md-2">
                                    ...
                                    <div class="featured-slider-1-items">
                                        <div class="slider-single p-10">
                                            <div
                                                ...
                                                <a href="single.html">
                                                    <img src="{{ staticAsset("frontend/assets/imgs/news-8.jpg") }}"
                                                         alt="post-slider">
                                                </a>
                                            </div>
                                            <div class="pr-10 pl-10">
                                                <div class="entry-meta mb-30">
                                                    <a class="entry-meta meta-0" href="category.html"><span
                                                            class="post-in background1 text-danger font-x-small">Economy</span></a>
                                                    <div class="float-right font-small">
                                                        ...
                                                        <span class="ml-30"><span class="mr-10 text-muted"><i
                                                                    class="fa fa-comment" aria-hidden="true"></i></span>2.5k</span>
                                                        <span class="ml-30"><span class="mr-10 text-muted"><i
                                                                    class="fa fa-share-alt"
                                                                    aria-hidden="true"></i></span>125k</span>
                                                    </div>
                                                </div>
                                                <h4 class="post-title mb-20"><a href="#">‘People Are Getting in Planes’:
                                                        The Travel Business Is Picking Up</a></h4>
                                                <div class="mb-20 overflow-hidden">
                                                    <div class="entry-meta meta-2 float-left">
                                                        <a class="float-left mr-10 author-img" href="author.html"
                                                           tabindex="0"><img
                                                                src="{{ staticAsset("frontend/assets/imgs/authors/author.png") }}"
                                                                alt=""></a>
                                                        <a href="author.html" tabindex="0"><span
                                                                class="author-name text-grey">B. Johnathan</span></a>
                                                        <br>
                                                        <span class="author-add color-grey">Maidstone, Kent</span>
                                                    </div>
                                                    <div class="float-right">
                                                        <a href="single.html" class="read-more"><span class="mr-10"><i
                                                                    class="fa fa-thumbtack"
                                                                    aria-hidden="true"></i></span>Picked by Editor</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slider-single pt-10 pl-10 pr-10 pb-10">
                                            <div
                                                ...
                                                <a href="single.html">
                                                    <img src="{{ staticAsset("frontend/assets/imgs/slide-1.jpg") }}"
                                                         alt="post-slider">
                                                </a>
                                            </div>
                                            <div class="pr-10 pl-10">
                                                ...
                                                <h4 class="post-title mb-20"><a href="#">NASA Picks Moon Lander Designs
                                                        by Elon Musk and Jeff Bezos Rocket Companies</a></h4>
                                                <div class="mb-20 overflow-hidden">
                                                    <div class="entry-meta meta-2 float-left">
                                                        <a class="float-left mr-10 author-img" href="author.html"
                                                           tabindex="0"><img
                                                                src="{{ staticAsset("frontend/assets/imgs/authors/author-1.png") }}"
                                                                alt=""></a>
                                                        <a href="author.html" tabindex="0"><span
                                                                class="author-name text-grey">Steven Keni</span></a>
                                                        <br>
                                                        <span class="author-add color-grey">Maidstone, Kent</span>
                                                    </div>
                                                    <div class="float-right">
                                    ...
                                    <div class="row">
                                        <div class="slider-single col-md-6 mb-30">
                                            <div class="img-hover-scale border-radius-10">
                                                ...
                                                <a href="single.html">
                                                    <img class="border-radius-10"
                                                         src="{{ staticAsset("frontend/assets/imgs/news-17.jpg") }}"
                                                         alt="post-slider">
                                                </a>
                                                <div class="play_btn play_btn_small">
                                                    <a class="play-video" href="https://vimeo.com/333834999"
                                            ...
                                            <h5 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                <a href="single.html">What Will It Take to Reopen the World to
                                                    Travel?</a>
                                            </h5>
                                            <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                <span><span class="mr-5"><i class="fa fa-eye"
                                                                            aria-hidden="true"></i></span>30k</span>
                                                <span class="ml-15"><span class="mr-5 text-muted"><i
                                                            class="fa fa-comment"
                                                            aria-hidden="true"></i></span>1.5k</span>
                                                <span class="ml-15"><span class="mr-5 text-muted"><i
                                                            class="fa fa-share-alt"
                                                            aria-hidden="true"></i></span>15k</span>
                                        ...
                                        <div class="slider-single col-md-6 mb-30">
                                            <div class="img-hover-scale border-radius-10">
                                                <a href="single.html">
                                                    <img class="border-radius-10"
                                                         src="{{ staticAsset("frontend/assets/imgs/news-18.jpg") }}"
                                                         alt="post-slider">
                                                </a>
                                                <div class="play_btn play_btn_small">
                                                    <a class="play-video" href="https://vimeo.com/333834999"
                                            ...
                                            <h5 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                <a href="single.html">Many Races, Little Time: Cycling Faces a Crowded
                                                    Calendar</a>
                                            </h5>
                                            <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                <span><span class="mr-5"><i class="fa fa-eye"
                                        ...
                                        <div class="slider-single col-md-6 mb-30">
                                            <div class="img-hover-scale border-radius-10">
                                                <a href="single.html">
                                                    <img class="border-radius-10"
                                                         src="{{ staticAsset("frontend/assets/imgs/news-19.jpg") }}"
                                                         alt="post-slider">
                                                </a>
                                                <div class="play_btn play_btn_small">
                                                    <a class="play-video" href="https://vimeo.com/333834999"
                                            ...
                                            <h5 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                <a href="single.html">Marathon Runners Build Their Sport Stride by
                                                    Stride</a>
                                            </h5>
                                            <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                <span><span class="mr-5"><i class="fa fa-eye"
                                        ...
                                        <div class="slider-single col-md-6 mb-30">
                                            <div class="img-hover-scale border-radius-10">
                                                <a href="single.html">
                                                    <img class="border-radius-10"
                                                         src="{{ staticAsset("frontend/assets/imgs/news-20.jpg") }}"
                                                         alt="post-slider">
                                                </a>
                                                <div class="play_btn play_btn_small">
                                                    <a class="play-video" href="https://vimeo.com/333834999"
                                            ...
                                            <h5 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                                                <a href="single.html">Casa Dani, From a Michelin Chef, to Open in
                                                    Manhattan West</a>
                                            </h5>
                                            <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                <span><span class="mr-5"><i class="fa fa-eye"
                                        ...
                                        <li class="mb-20">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-4.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Federal
                                                            arrests show no sign that antifa plotted protests</a></h6>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-15.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">How
                                                            line-dried laundry gets that fresh smell</a></h6>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="mb-20">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-16.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                            ...
                            <div class="sidebar-widget mb-30">
                                <div class="widget-top-auhor border-radius-10 p-20 bg-white">
                                    ...
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Emma - 1034 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-2.png") }}" alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Oliver - 245 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-3.png") }}" alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Sophia - 356 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-4.png") }}" alt=""></a>
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Emili - 152 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-5.png") }}" alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Harry - 245 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-17.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Noah - 758 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-7.png") }}" alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Isabella - 231 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-8.png") }}" alt=""></a>
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Charlie - 256 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-9.png") }}" alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Amelia - 652 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-10.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Jack - 125 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-11.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Elizabeth - 452 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-12.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Malcolm - 124 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-13.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Abigail - 1245 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-14.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Matthew - 1325 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-15.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Genesis - 562 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-16.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Charlie - 256 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-17.png") }}"
                                    ...
                                    <a class="red-tooltip" href="#" data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Amelia - 652 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-18.png") }}"
                                            alt=""></a>
                                    <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="Jack - 125 posts"><img
                                            src="{{ staticAsset("frontend/assets/imgs/authors/author-20.png") }}"
                                            alt=""></a>
                                </div>
                            </div>
                            <!--Newsletter-->
                                        ...
                                        <li class="mb-30 wow fadeIn animated">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-2.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="post-by">By <a
                                                                href="author.html">K. Marry</a></span>
                                                        <span class="post-on">4m ago</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li class="mb-30 wow fadeIn animated">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-3.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">4
                                                            Things Emotionally Intelligent People Don’t Do</a></h6>
                                                    <div
                                                        class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                                        <span class="post-by">By <a
                                                                href="author.html">Mr. John</a></span>
                                                        <span class="post-on">3h ago</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li class="mb-30 wow fadeIn animated">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-5.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                        ...
                                        <li class="mb-30 wow fadeIn animated">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-7.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                        ...
                                        <li class="wow fadeIn animated">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="single.html">
                                                        <img
                                                            src="{{ staticAsset("frontend/assets/imgs/thumbnail-8.jpg") }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a href="single.html">Blackface
                                                            Minstrel Songs Don’t Belong in Children’s Music Class</a>
                                                    </h6>
                                                    <div
                                                        class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                                        <span class="post-by">By <a
                                                                href="author.html">J.Smith</a></span>
                                                        <span class="post-on">5h30 ago</span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center mt-50 mb-50">
                            <a href="#">
                                <img class="border-radius-10 d-inline"
                                     src="{{ staticAsset("frontend/assets/imgs/ads.jpg") }}" alt="post-slider">
                            </a>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="loop-list-style-1">
                                    <article
                                        ...
                                        <div
                                            ...
                                            <a href="single.html">
                                                <img src="{{ staticAsset("frontend/assets/imgs/news-21.jpg") }}"
                                                     alt="post-slider">
                                            </a>
                                        </div>
                                        <div class="pr-10 pl-10">
                                            <div class="entry-meta mb-30">
                                                ...
                                                <div class="float-right font-small">
                                                    ...
                                                    <span class="ml-30"><span class="mr-10 text-muted"><i
                                                                class="fa fa-comment" aria-hidden="true"></i></span>2.5k</span>
                                                    <span class="ml-30"><span class="mr-10 text-muted"><i
                                                                class="fa fa-share-alt" aria-hidden="true"></i></span>125k</span>
                                                </div>
                                            </div>
                                            <h4 class="post-title mb-20">
                                                ...
                                                <a href="single.html">Team Bitbose geared up to attend Blockchain World
                                                    Conference ’18 in Atlantic City, New Jersey</a></h4>
                                            <div class="mb-20 overflow-hidden">
                                                <div
                                                    class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                                ...
                                                <div class="float-right">
                                                    <a href="single.html" class="read-more"><span class="mr-10"><i
                                                                class="fa fa-thumbtack" aria-hidden="true"></i></span>Picked
                                                        by Editor</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="post-content media-body">
                                                <div class="entry-meta mb-15 mt-10">
                                                    <a class="entry-meta meta-2" href="category.html"><span
                                                            class="post-in text-danger font-x-small">Politic</span></a>
                                                </div>
                                                <h5 class="post-title mb-15 text-limit-2-row">
                                                    ...
                                                    <a href="single.html">More than 1.5 million people sought state
                                                        unemployment benefits last week even as businesses reopened.</a>
                                                </h5>
                                                <div
                                                    class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                                    <span class="post-by">By <a
                                                            href="author.html">Sean Boynton</a></span>
                                    ...
                                    <article class="p-10 background-white border-radius-10 mb-30 wow fadeIn animated">
                                        <div class="d-flex">
                                            <div class="post-thumb d-flex mr-15 border-radius-15 img-hover-scale">
                                                <a class="color-white" href="single.html">
                                                    <img class="border-radius-15"
                                                         src="{{ staticAsset("frontend/assets/imgs/thumbnail-13.jpg") }}"
                                                         alt="">
                                                </a>
                                            </div>
                                            <div class="post-content media-body">
                                                <div class="entry-meta mb-15 mt-10">
                                                    <a class="entry-meta meta-2" href="category.html"><span
                                                            class="post-in text-warning font-x-small">Religion</span></a>
                                                </div>
                                                <h5 class="post-title mb-15 text-limit-2-row">
                                                    <a href="single.html">Elite B.C., Ontario crime network laundering
                                                        ‘hundreds of millions’ a year, inquiry hears</a></h5>
                                                <div
                                                    class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                                    <span class="post-by">By <a
                                                            href="author.html">Walter Cronkite</a></span>
                                    ...
                                    <article class="p-10 background-white border-radius-10 mb-30 wow fadeIn animated">
                                        <div class="d-flex">
                                            ...
                                            <div class="post-content media-body">
                                                <div class="entry-meta mb-15 mt-10">
                                                    <a class="entry-meta meta-2" href="category.html"><span
                                                            class="post-in text-success font-x-small">Healthy</span></a>
                                                </div>
                                                <h5 class="post-title mb-15 text-limit-2-row">
                                                        <span class="post-format-icon">
                                                            <ion-icon name="image-outline"></ion-icon>
                                                        </span>
                                                    <a href="single.html">Daycares are opening across the country, but
                                                        can they really operate safely?</a></h5>
                                                <div
                                                    class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                                    <span class="post-by">By <a
                                                            href="author.html">JONATHAN LEMIRE</a></span>
                                    ...
                                    <article class="p-10 background-white border-radius-10 mb-30 wow fadeIn animated">
                                        <div class="d-flex">
                                            ...
                                            <div class="post-content media-body">
                                                <div class="entry-meta mb-15 mt-10">
                                                    <a class="entry-meta meta-2" href="category.html"><span
                                                            class="post-in text-info font-x-small">Conflicts</span></a>
                                                </div>
                                                <h5 class="post-title mb-15 text-limit-2-row">
                                                        <span class="post-format-icon">
                                ...
                                <div class="post-aside-style-3">
                                    ...
                                    <article class="bg-white border-radius-15 mb-30 p-10 wow fadeIn animated">
                                        <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                                            <a href="single.html">
                                                <img class="border-radius-15"
                                                     src="{{ staticAsset("frontend/assets/imgs/news-22.jpg") }}" alt="">
                                            </a>
                                        </div>
                                        <div class="pl-10 pr-10">
                                    ...
                                    <article class="bg-white border-radius-15 mb-30 p-10 wow fadeIn animated">
                                        <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                                            <a href="single.html">
                                                <img class="border-radius-15"
                                                     src="{{ staticAsset("frontend/assets/imgs/news-20.jpg") }}" alt="">
                                            </a>
                                        </div>
                                        <div class="pl-10 pr-10">
                                ...
                                <div class="post-block-list post-module-6">
                                    <div class="last-comment mb-20 d-flex wow fadeIn animated">
                                        ...
                                        <div class="alith_post_title_small">
                                            <p class="font-medium mb-10"><a href="single.html">A writer is someone for
                                                    whom writing is more difficult than it is for other people.</a></p>
                                            <div
                                                class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase mb-10">
                                            ...
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip"
                                                   ...
                                                   data-original-title="Harry - 1245 posts"><img
                                                        src="{{ staticAsset("frontend/assets/imgs/authors/author-9.png") }}"
                                                        alt=""></a>
                                            </span>
                                        <div class="alith_post_title_small">
                                            <p class="font-medium mb-10"><a href="single.html">Riding the main trail was
                                                    easy, a little bumpy because my mountain bike is a hardtail</a></p>
                                            <div
                                                class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase mb-10">
                                            ...
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip"
                                                   ...
                                                   data-original-title="Johny - 445 posts"><img
                                                        src="{{ staticAsset("frontend/assets/imgs/authors/author-3.png") }}"
                                                        alt=""></a>
                                            </span>
                                        <div class="alith_post_title_small">
                                            <p class="font-medium mb-10"><a href="single.html">Teamwork begins by
                                                    building trust. And the only way to do that is to overcome our need
                                                    for invulnerability.</a></p>
                                            <div
                                                class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase mb-10">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="post-carausel-2 post-module-1 row">
                                <div class="col">
                                    <div class="post-thumb position-relative">
                                        <div class="thumb-overlay img-hover-slide border-radius-15 position-relative"
                                             style="background-image: url({{ staticAsset("fron") }})">
                                            <a class="img-link" href="single.html"></a>
                                            <div class="post-content-overlay">
                                                <div class="entry-meta meta-0 font-small mb-15">
                                                    <a href="category.html"><span
                                                            class="post-cat bg-success color-white">Travel</span></a>
                                                </div>
                                                <h5 class="post-title">
                                                    <a class="color-white" href="single.html">Tesla’s Cooking Up A New
                                                        Way To Wire Its Cars, Report Says</a>
                                                </h5>
                                                <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                    <span><span class="mr-5"><i class="fa fa-eye"
                                                                                aria-hidden="true"></i></span>5.8k</span>
                                ...
                                <div class="col">
                                    <div class="post-thumb position-relative">
                                        <div class="thumb-overlay img-hover-slide border-radius-15 position-relative"
                                             style="background-image: url({{staticAsset("frontend/assets/imgs/thumbnail-8.jpg")}})">
                                            <a class="img-link" href="single.html"></a>
                                            <div class="post-content-overlay">
                                                <div class="entry-meta meta-0 font-small mb-15">
                                                ...
                                                <h5 class="post-title">
                                                    <a class="color-white" href="single.html">Ratcliffe to be Director
                                                        of nation talent Trump ignored</a>
                                                </h5>
                                                <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                    <span><span class="mr-5"><i class="fa fa-eye"
                                                                                aria-hidden="true"></i></span>5.8k</span>
                                ...
                                <div class="col">
                                    <div class="post-thumb position-relative">
                                        <div class="thumb-overlay img-hover-slide border-radius-15 position-relative"
                                             style="background-image: url({{ staticAsset("frontend/assets/imgs/thumbnail-10.jpg") }})">
                                            <a class="img-link" href="single.html"></a>
                                            <div class="post-content-overlay">
                                                <div class="entry-meta meta-0 font-small mb-15">
                                                    <a href="category.html"><span
                                                            class="post-cat bg-danger color-white">Art</span></a>
                                                </div>
                                                <h5 class="post-title">
                                                    <a class="color-white" href="single.html">Countries seek ‘new
                                                        history’ as figures are re-examined</a>
                                                </h5>
                                                <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                    <span><span class="mr-5"><i class="fa fa-eye"
                                                                                aria-hidden="true"></i></span>5.8k</span>
                                ...
                                <div class="col">
                                    <div class="post-thumb position-relative">
                                        <div class="thumb-overlay img-hover-slide border-radius-15 position-relative"
                                             style="background-image: url({{staticAsset("frontend/assets/imgs/thumbnail-15.jpg")}})">
                                            <a class="img-link" href="single.html"></a>
                                            <div class="post-content-overlay">
                                                <div class="entry-meta meta-0 font-small mb-10">
                                                    <a href="category.html"><span
                                                            class="post-cat bg-warning color-white">Gaming</span></a>
                                                </div>
                                                <h5 class="post-title">
                                                    <a class="color-white" href="single.html">The secret to moving this
                                                        ancient sphinx screening</a>
                                                </h5>
                                                <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                    <span><span class="mr-5"><i class="fa fa-eye"
                                                                                aria-hidden="true"></i></span>5.8k</span>
                                ...
                                <div class="col">
                                    <div class="post-thumb position-relative">
                                        <div class="thumb-overlay img-hover-slide border-radius-15 position-relative"
                                             style="background-image: url({{ staticAsset("frontend/assets/imgs/thumbnail-16.jpg") }})">
                                            <a class="img-link" href="single.html"></a>
                                            <div class="post-content-overlay">
                                                <div class="entry-meta meta-0 font-small mb-10">
                                                    <a href="category.html"><span
                                                            class="post-cat bg-primary color-white">Garden</span></a>
                                                </div>
                                                <h5 class="post-title">
                                                    <a class="color-white" href="single.html">Harbour amid a Slowen down
                                                        in singer city screening</a>
                                                </h5>
                                                <div class="entry-meta meta-1 font-x-small mt-10 pr-5 pl-5 text-muted">
                                                    <span><span class="mr-5"><i class="fa fa-eye"
                                                                                aria-hidden="true"></i></span>5.8k</span>
